...
function sEf(editableObj, table, updCol, pcol1, pid1) {
  ...
  $(editableObj).keyup(function (e) {
    ...
    if (
      (e.which < 32 ||
        e.which > 127 || // outside alphanumeric/characters (32-127)
...
function sT(editableObj, table, updCol, pcol1, pid1, col2, id2, col3, id3, col4, id4, col5, id5, updVal) {
  // saveTo
  ...
  if (updVal === "" || typeof updVal == "undefined") {
    if (eType == "textarea" || eType == "select" || eType == "input") {
      ...
      alert("error: unrecognised element type " + eType);
      return;
    }
  }
  ...
  if (
    ...
    updVal = "NULL";
  if (table == "itemattributes" && updCol == "deadline" && (updVal == "\n" || typeof updVal == "undefined"))
    updVal = "NULL";
  ...
  let calcCareerIds = [
    ...
    51, 52, 53, 54 /* Personal Fit */, 521, 522 /* Sum-Cr */ /* specifically career items*/, 722, 723, 724, 725, 726,
    727 /* Career Capital */, 771, 772, 773, 774, 775, 776, 777, 778 /* Impact Scale */, 781, 782, 783, 784, 785,
    786 /* Impact Neglectedness */, 791, 792 /* Impact Solvability */, 812, 813, 814, 815, 816,
    817 /* Conditions Sum */, 822, 823 /* Conditions Needs */, 831, 832, 833, 834, 835, 836 /* Conditions Locality */,
    841, 842, 843, 844 /* Conditions Income */, 853, 854, 855, 856 /* Personal Fit */,
  ];
...
function calcCL(checklistId) {
  delay(function () {
    // call CL calculation within delay cycle to allow CL item write to occur first
    $.ajax({
