    ...
    <script>
      function particle() {
        ...
        var windows = [
          ...
          "reportLists.php?listId=137&type=c", // third window etc.
          "itemReport.php?itemId=6030", // second window
          "editListItems.php?itemId=8031&type=c", // first/current window
        ];
