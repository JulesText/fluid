...
<form action="processLists.php" method="post" onsubmit="return validate(this);">
    <div class='form'>
        ...
        <div class='formrow'>
            ...
            <?php } else {
                echo "<p>" . makeclean($values['item']) . "</p>";
            } ?>
        </div>
        <div class='formrow'>
            ...
            <?php } else {
                echo "<p>" . makeclean($values['notes']) . "</p>";
            } ?>
        </div>
        <div class='formrow'>
            ...
            <input class='JKPadding' type='text' name='hyperlink' id='hyperlink' value='<?php echo makeclean($values['hyperlink']); ?>' size='80' <?php if ($isInst) {
                echo "hidden";
                                                                                        } ?> />
        </div>
        <div class='formrow'>
