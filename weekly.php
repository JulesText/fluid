...
<table class='weeklytable' summary='Table of weekly actions'>
    ...
    <tr><td>Empty your head</td>
        <td>Put in writing any new
            ...
            <a href="item.php?type=a" title="Add action">actions</a>, things you are
            <a href="item.php?type=w" title="Add waitingOn">waiting for</a>,
            <a href="item.php?type=r" title="Add reference">references</a>,
            <a href="http://sphinx.jules.net.au" title="SphinxWiki">SphinxWiki</a>,
...
<?php if ($orphancnt) { ?>
    <tr><td>Re-parent your <a href='orphans.php'>orphans</a></td>
        <td>You have <?php echo $orphancnt?> orphan<?php if ($orphancnt > 1) {
            echo "s";
                     } ?> that need<?php if ($orphancnt == 1) {
                     echo "s";
                     } ?> to be addressed.
...
<?php } ?>
    <tr>
        ...
        if ($numNoNext) {
            ...
            echo "All $numProjects have next actions defined.";
        }
        ?></td>
    </tr>
    ...
    <tr><td>Review <a href="listLists.php?type=L">Lists</a></td><td>Review relevant lists for actionable items or projects. Add to, update or scrap lists.</td></tr>
    <tr><td>Review <a href="listLists.php?type=C">Checklists</a></td><td>Review relevant Checklists for actionable items or projects. Add to, update or scrap checklists.</td></tr>
...
<?php
if (!empty($config['show7'])) {
    include_once('sevenhabits.php');
}
