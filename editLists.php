...
<form action='processLists.php' method='post' onsubmit="return validate(this);">
    ...
    <div class='formbuttons'>
        ...
        <input type="checkbox" name="menu" id='menu' class='notfirst' title="" value="y" <?php if ($values['menu'] === 'y') {
      ...
      <select name='sortItems' id='sortItems'>
        <option value="priority" <?php if ($values['sortItems'] == 'priority') {
            echo ' selected="selected"';
                                 } ?>>prioritise > title > notes</option>
        <option value="title_notes" <?php if ($values['sortItems'] == 'title_notes') {
            echo ' selected="selected"';
                                    } ?>>title 2 > notes 4 > prioritise</option>
        <option value="title" <?php if ($values['sortItems'] == 'title') {
            echo ' selected="selected"';
                              } ?>>title > notes 4 > prioritise</option>
        <option value="title_priority" <?php if ($values['sortItems'] == 'title_priority') {
            echo ' selected="selected"';
                                       } ?>>title > prioritise > notes</option>
      </select>
        ...
        <br>
        <br>
    <input type="checkbox" name="scored" id='scored' class='notfirst' title="" value="y" <?php if ($values['scored'] === 'y') {
        echo " checked='checked'";
                                                                                         }?>/>
